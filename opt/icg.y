...
%start S
%token<text> T_lt T_gt T_lteq T_gteq T_neq T_noteq T_eqeq T_and T_or T_incr T_decr T_not T_eq T_ques T_colon 
%token<text> ID NUM STRING VAR IF ELSE BREAK WHILE CONTINUE FOR  

%token<text> T_pl T_min T_mul T_div
%left T_lt T_gt
%left T_pl T_min
%left T_mul T_div
