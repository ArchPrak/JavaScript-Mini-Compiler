...
%start S
%token T_lt T_gt T_lteq T_gteq T_neq T_noteq T_eqeq T_and T_or T_incr T_decr T_not T_eq T_ques T_colon 
%token ID NUM STRING VAR IF ELSE BREAK WHILE CONTINUE FOR  
